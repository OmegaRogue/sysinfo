...
type NetworkDevice struct {
	...
	MACAddress string `json:"macaddress,omitempty" cty:"macaddress" hcl:"macaddress,optional"`
	Port       string `json:"port,omitempty" cty:"port" hcl:"port,optional"`
	Speed      uint   `json:"speed,omitempty" cty:"speed" hcl:"speed,optional"` // device max supported speed in Mbps
}
